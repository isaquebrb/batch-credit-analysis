...
public enum AnalysisValidationEnum {
    ...
    MAXIMUM_VALUE_BACEN_PENDENCY(InformationTypeEnum.CREDNET), //Valor máximo de cheques sem fundo
    ...
    MAXIMUM_RATE_NON_PAYMENT(InformationTypeEnum.CREDNET), //Taxa máxima de inadimplencia
